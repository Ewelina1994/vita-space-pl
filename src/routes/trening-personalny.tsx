  ...
  head: () => ({
    meta: [
      { title: "Trening personalny — Vita Space" },
      {
        name: "description",
        content:
          "Trening personalny indywidualny lub w parach w studio Vita Space. Indywidualny plan, opieka trenera, mierzalne efekty.",
      },
      { property: "og:title", content: "Trening personalny — Vita Space" },
      {
        property: "og:description",
        content:
          "Trening personalny indywidualny lub w parach w studio Vita Space. Indywidualny plan, opieka trenera, mierzalne efekty.",
      },
      { property: "og:url", content: buildCanonicalUrl("/trening-personalny") },
      { property: "og:image", content: absoluteAssetUrl(personalImg) },
    ],
    links: [canonicalLink("/trening-personalny")],
  }),
      ...
      <Section title="Twój cel — nasza metoda">
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-5 text-muted-foreground leading-relaxed">
            <p>
              W Vita Space trening personalny to znacznie więcej niż wspólne ćwiczenia. To{" "}
              <strong className="text-foreground">indywidualny plan treningowy</strong> ułożony pod
              Twój cel — redukcja tkanki tłuszczowej, budowa masy mięśniowej, poprawa kondycji,
              rehabilitacja po urazie czy powrót do formy po ciąży.
            </p>
            <p>
              Trener prowadzi Cię przez każde powtórzenie — dba o technikę, dobiera intensywność i
              motywuje do przekraczania granic. Wszystko odbywa się w{" "}
              <strong className="text-foreground">kameralnej, dyskretnej atmosferze</strong> naszego
              studia.
            </p>
            <p>
              Wybierz format, który pasuje do Ciebie:{" "}
              <strong className="text-foreground">1:1</strong> dla pełnej uwagi trenera, lub{" "}
              <strong className="text-foreground">w parach</strong> — z partnerem, przyjaciółką czy
              członkiem rodziny.
            </p>
          </div>
          <div className="grid gap-5">
            <div className="rounded-xl border border-border bg-card p-8">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Pełna uwaga trenera, maksymalna intensywność i najszybsze efekty. Idealny dla osób,
                które oczekują pełnej dyskrecji i najwyższej jakości.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-8">
      ...
      <section className="bg-navy-deep/50 border-y border-border/60">
        <div className="max-w-7xl mx-auto px-6 py-20">
          <h2 className="text-3xl md:text-4xl mb-10 max-w-2xl">
            Co obejmuje trening personalny w Vita Space
          </h2>
