...
export const Route = createFileRoute("/trening-ems")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Trening EMS w Vita Space: elektrostymulacja mięśni, wskazania, przeciwwskazania i efekty. 20 minut = kilka godzin klasycznego treningu." },
...
function EmsPage() {
  return (
    <SiteLayout>
      <PageHero
        eyebrow="Trening EMS"
        title="20 minut, które zmieniają Twoją sylwetkę"
        subtitle="Elektrostymulacja mięśni — najbardziej efektywna forma treningu XXI wieku, dostępna w premium wydaniu w studio Vita Space."
        image={heroEms}
      />
      ...
      <Section eyebrow="Co to jest EMS" title="Trening EMS — czyli co dokładnie?">
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-5 text-muted-foreground leading-relaxed">
            <p>
              <strong className="text-foreground">EMS (Electrical Muscle Stimulation)</strong> to nowoczesna metoda treningowa,
              w której specjalny kombinezon z elektrodami przesyła bezpieczne impulsy elektryczne do Twoich mięśni.
              Impulsy te wywołują dodatkowe skurcze mięśniowe — dokładnie takie, jakie normalnie generuje mózg podczas ćwiczeń.
            </p>
            <p>
              Podczas 20-minutowej sesji aktywowanych jest <strong className="text-foreground">nawet 90% włókien mięśniowych</strong> jednocześnie —
              w tym mięśnie głębokie, których nie da się skutecznie pobudzić klasycznym treningiem. Efekt jednej sesji EMS
              odpowiada kilkugodzinnemu treningowi siłowemu.
            </p>
            <p>
              Trening prowadzony jest zawsze <strong className="text-foreground">pod okiem certyfikowanego trenera personalnego</strong>,
              który dobiera intensywność impulsów oraz zestaw ćwiczeń do Twojego celu — redukcji, wzmocnienia, ujędrnienia
              sylwetki czy rehabilitacji.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4 content-start">
            {[
              { i: Clock, t: "20 minut", d: "Czas jednej sesji EMS" },
              ...
              <div key={s.t} className="rounded-xl border border-border bg-card p-6">
                ...
                <div className="text-xs uppercase tracking-widest text-muted-foreground mt-1">{s.d}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-navy-deep/50 border-y border-border/60">
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Masz mało czasu — 20 minut to wszystko, czego potrzebujesz",
            ...
            <div>
              <div className="text-xs uppercase tracking-[0.35em] text-destructive mb-4">Przeciwwskazania</div>
              ...
              <p className="mt-6 text-xs text-muted-foreground">
                Przed pierwszym treningiem zawsze przeprowadzamy szczegółowy wywiad zdrowotny.
      ...
      <Section eyebrow="Jak wygląda trening" title="Twoja sesja krok po kroku">
        <div className="grid md:grid-cols-4 gap-6">
          {[
            ...
            { n: "02", t: "Przygotowanie", d: "Zakładasz kombinezon EMS oraz specjalną, nawilżoną odzież." },
            { n: "03", t: "Trening 20 min", d: "Proste ćwiczenia z trenerem — squaty, wykroki, plank." },
            { n: "04", t: "Regeneracja", d: "Prysznic, opcjonalna presoterapia i plan na kolejny trening." },
          ].map((s) => (
