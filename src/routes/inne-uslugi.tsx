...
export const Route = createFileRoute("/inne-uslugi")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: bodyshaping },
    ],
  }),
  ...
  return (
    <SiteLayout>
      ...
      <Section eyebrow="Body Shaping" title="Body Shaping (masaż podciśnieniowy)">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div className="rounded-2xl overflow-hidden">
            <img src={dermomasaz} alt="Body Shaping" loading="lazy" className="w-full h-full object-cover" />
          </div>
          <div className="space-y-5 text-muted-foreground leading-relaxed">
            <p>
              <strong className="text-foreground">Body Shaping</strong> to nowoczesny zabieg wykorzystujący
              masaż ssąco-próżniowy, który pobudza krążenie, wspiera redukcję cellulitu i pomaga wymodelować
              sylwetkę. Regularne zabiegi mogą poprawić jędrność skóry, zmniejszyć obrzęki oraz wspomóc proces
              wyszczuplania.
            </p>
            ...
            <p>
              Idealny dla osób, które chcą wygładzić skórę, zmniejszyć widoczność cellulitu i podkreślić
              kształty sylwetki.
            </p>
          </div>
        </div>
      ...
      <section className="bg-navy-deep/50 border-y border-border/60">
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-28">
          ...
          <h2 className="text-4xl md:text-5xl leading-tight mb-12 max-w-3xl">Liposucja kawitacyjna — redukcja tkanki tłuszczowej</h2>
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-5 text-muted-foreground leading-relaxed order-2 lg:order-1">
              <p>
                <strong className="text-foreground">Liposucja kawitacyjna</strong> jest używana do redukcji tkanki tłuszczowej w trudno dostępnych obszarach. To nieinwazyjny zabieg, który rozbija komórki tłuszczowe, pozbawiając się ich naturalnie poprzez organizm.
              </p>
              <p className="font-medium text-foreground">Doskonała do modelowania:</p>
              <ul className="space-y-2">
                {["Brzucha i boczków", "Wewnętrznych stron ud", "Pośladków", "Obszarów trudno dostępnych"].map((t) => (
                  <li key={t} className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-gold shrink-0 mt-0.5" />
                    <span className="text-sm">{t}</span>
                  </li>
            ...
            <div className="rounded-2xl overflow-hidden order-1 lg:order-2">
              <img src={liposukcja} alt="Liposucja kawitacyjna" loading="lazy" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <Section eyebrow="Radiofrekwencja" title="Radiofrekwencja — podgrzewanie i napięcie skóry">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div className="rounded-2xl overflow-hidden">
            <img src={bodyshaping} alt="Radiofrekwencja" loading="lazy" className="w-full h-full object-cover" />
          </div>
          <div className="space-y-5 text-muted-foreground leading-relaxed">
            <p>
              <strong className="text-foreground">Radiofrekwencja</strong> podgrzewa tkankę, poprawiając jej napięcie i kondycję. To zabieg, który stymuluje produkcję kolagenu i elastyny, wzmacniając strukturę skóry i przywracając jej naturalny blask.
            </p>
            <p className="font-medium text-foreground">Efekty zabiegu:</p>
            <ul className="space-y-2">
              {["Znaczna poprawa napięcia skóry", "Wzmocnienie kondycji tkanki", "Wygładzenie zmarszczek", "Naturalne ujędrnienie"].map((t) => (
                <li key={t} className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-gold shrink-0 mt-0.5" />
                  <span className="text-sm">{t}</span>
                </li>
      ...
      <section className="bg-navy-deep/50 border-y border-border/60">
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-28">
          ...
          <h2 className="text-4xl md:text-5xl leading-tight mb-12 max-w-3xl">Lipolaser — stymulacja metabolizmu i rozbicie tkanki tłuszczowej</h2>
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-5 text-muted-foreground leading-relaxed order-2 lg:order-1">
              <p>
                <strong className="text-foreground">Lipolaser</strong> wykorzystuje światło laserowe do stymulacji procesów metabolicznych i rozbicia tkanki tłuszczowej, której pozostałości są następnie naturalnie wydalne z organizmu.
              </p>
              <p>
                To nowoczesna, nieinwazyjne rozwiązanie wspierające redukcję lokalizacji opornych na trening i dietę.
              </p>
              <p className="font-medium text-foreground">Wskazania:</p>
              <ul className="space-y-2">
                {["Stymulacja procesów metabolicznych", "Redukcja tkanki tłuszczowej", "Wspieranie naturalnej detoksykacji", "Idealne uzupełnienie kawitacji"].map((t) => (
                  <li key={t} className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-gold shrink-0 mt-0.5" />
                    <span className="text-sm">{t}</span>
                  </li>
            ...
            <div className="rounded-2xl overflow-hidden order-1 lg:order-2">
              <img src={lipolaser} alt="Lipolaser" loading="lazy" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="max-w-7xl mx-auto px-6 py-20 md:py-28">
          <div className="max-w-3xl mb-10">
            ...
            <h2 className="text-4xl md:text-5xl leading-tight mb-8">Przeciwwskazania do zabiegów</h2>
          </div>
